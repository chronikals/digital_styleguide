...
!function(t, e) {
    ...
    t.Controller = function(r) {
        var s, a, o = "ScrollMagic.Controller", l = "FORWARD", h = "REVERSE", u = "PAUSED", c = i.defaults, f = this, p = n.extend({}, c, r), _ = [], d = !1, m = 0, g = u, v = !0, y = 0, T = !0, w = function() {
                for (var e in p)
                    c.hasOwnProperty(e) || (A(2, 'WARNING: Unknown option "' + e + '"'),
                        delete p[e]);
                if (p.container = n.get.elements(p.container)[0],
                        !p.container)
                    throw A(1, "ERROR creating object " + o + ": No valid scroll container supplied"),
                    o + " init failed.";
                ...
                v && (p.container = window),
                    ...
                    x(),
                    A(3, "added new " + o + " controller (v" + t.version + ")")
            }, x = function() {
                ...
                if (T && d) {
                    ...
                    g === h && t.reverse(),
                        t.forEach(function(e, i) {
                            A(3, "updating Scene " + (i + 1) + "/" + t.length + " (" + _.length + " total)"),
                                e.update(!0)
                        }),
        ...
        return this.addScene = function(e) {
            if (n.type.Array(e))
                ...
                if (e.controller() !== f)
                    ...
                    A(3, "adding Scene (now " + _.length + " total)")
                }
            } else
            ...
            this.removeScene = function(t) {
                if (n.type.Array(t))
                    ...
                    e > -1 && (t.off("shift.controller_sort"),
                        _.splice(e, 1),
                        A(3, "removing Scene (now " + _.length + " left)"),
                        t.remove())
                }
                return f
            }
            ...
            this.updateScene = function(e, i) {
                return n.type.Array(e) ? e.forEach(function(t, e) {
                        f.updateScene(t, i)
                    }) : i ? e.update(!0) : d !== !0 && e instanceof t.Scene && (d = d || [],
            ...
            this.scrollTo = function(i, r) {
                if (n.type.Number(i))
                    ...
                    i.controller() === f ? f.scrollTo(i.scrollOffset(), r) : A(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", i);
            ...
            this.scrollPos = function(t) {
                return arguments.length ? (n.type.Function(t) ? b = t : A(2, "Provided value for method 'scrollPos' is not a function. To change the current scroll position use 'scrollTo()'."),
                        f) : b.call(f)
            }
            ,
            ...
            this.destroy = function(t) {
                ...
                return p.container.removeEventListener("resize", k),
                    ...
                    n.cAF(s),
                    A(3, "destroyed " + o + " (reset: " + (t ? "true" : "false") + ")"),
                    null
            }
            ,
            w(),
    ...
    t.Controller.addOption = function(t, e) {
        ...
        ,
        t.Scene = function(i) {
            var s, a, o = "ScrollMagic.Scene", l = "BEFORE", h = "DURING", u = "AFTER", c = r.defaults, f = this, p = n.extend({}, c, i), _ = l, d = 0, m = {
                start: 0,
                end: 0
            }, g = 0, v = !0, y = function() {
                for (var t in p)
                    c.hasOwnProperty(t) || (w(2, 'WARNING: Unknown option "' + t + '"'),
                        delete p[t]);
                for (var e in c)
                    C(e);
                O()
            ...
            this.on = function(t, e) {
                ...
                this.off = function(t, e) {
                    return t ? (t = t.trim().split(" "),
                            ...
                            f) : (w(1, "ERROR: Invalid event name supplied."),
                            f)
                }
                ,
            ...
            this.addTo = function(e) {
                return e instanceof t.Controller ? a != e && (a && a.removeScene(f),
                        a = e,
                        O(),
                        b(!0),
                        P(!0),
                        ...
                        w(3, "added " + o + " to controller"),
                        f.update()) : w(1, "ERROR: supplied argument of 'addTo()' is not a valid ScrollMagic Controller"),
                    f
            }
                ,
                this.enabled = function(t) {
                ...
                this.destroy = function(t) {
                    return f.trigger("destroy", {
                        ...
                        f.remove(),
                        f.off("*.*"),
                        w(3, "destroyed " + o + " (reset: " + (t ? "true" : "false") + ")"),
                        null
                }
                ,
                this.update = function(t) {
            ...
            var x = function() {
                ...
                var i = 0
                    , r = p.triggerElement;
                if (a && r) {
                    for (var s = a.info(), o = n.get.offset(s.container), l = s.vertical ? "top" : "left"; r.parentNode.hasAttribute(e); )
                        r = r.parentNode;
                ...
                , O = function(t) {
                t = arguments.length ? [t] : Object.keys(R),
                    t.forEach(function(t, e) {
                        var i;
                        if (R[t])
                            try {
                                ...
                                n.type.Array(s) ? (s[0] = "ERROR: " + s[0],
                                        s.unshift(1),
                                        w.apply(this, s)) : w(1, "ERROR: Problem executing validation callback for option '" + t + "':", r.message)
                            } finally {
                                p[t] = i
                            }
                    })
            ...
            this.controller = function() {
                ...
                this.triggerPosition = function() {
                    var t = p.offset;
                    return a && (t += p.triggerElement ? g : a.info("size") * f.triggerHook()),
                        t
                }
            ;
            var A, M;
            ...
            var D = function(t) {
                if (A && a) {
                    ...
                    if (t || _ !== h) {
                        ...
                        M.pushFollowers ? p.duration > 0 && (_ === u && 0 === parseFloat(n.css(M.spacer, "padding-top")) ? s = !0 : _ === l && 0 === parseFloat(n.css(M.spacer, "padding-bottom")) && (s = !0)) : r[e.vertical ? "top" : "left"] = p.duration * d,
                            n.css(i, r),
                        s && E()
                    } else {
                ...
                if (A && a && M.inFlow) {
                    ...
                    M.relSize.width || M.relSize.autoFullWidth ? t ? n.css(A, {
                                ...
                                width: "100%"
                            }) : (s["min-width"] = n.get.width(e ? A : i, !0, !0),
                            s.width = t ? s["min-width"] : "auto"),
                        M.relSize.height ? t ? n.css(A, {
                                    height: n.get.height(M.spacer) - (M.pushFollowers ? p.duration : 0)
                                }) : n.css(A, {
                                    height: "100%"
                                }) : (s["min-height"] = n.get.height(e ? i : A, !0, !r),
                                s.height = t ? s["min-height"] : "auto"),
                    M.pushFollowers && (s["padding" + (e ? "Top" : "Left")] = p.duration * d,
                        s["padding" + (e ? "Bottom" : "Right")] = p.duration * (1 - d)),
                        n.css(M.spacer, s)
                }
            }
                , F = function() {
                a && A && _ === h && !a.info("isDocument") && D()
            }
                , z = function() {
                a && A && _ === h && ((M.relSize.width || M.relSize.autoFullWidth) && n.get.width(window) != n.get.width(M.spacer.parentNode) || M.relSize.height && n.get.height(window) != n.get.height(M.spacer.parentNode)) && E()
            }
                , I = function(t) {
                a && A && _ === h && !a.info("isDocument") && (t.preventDefault(),
            ...
            this.setPin = function(t, i) {
                ...
                A.parentNode.style.display = s,
                !o && i.pushFollowers && (w(2, "WARNING: If the pinned element is positioned absolutely pushFollowers will be disabled."),
                    i.pushFollowers = !1),
                    window.setTimeout(function() {
                        A && 0 === p.duration && i.pushFollowers && w(2, "WARNING: pushFollowers =", !0, "has no effect, when scene duration is 0.")
                    }, 0);
                ...
                if (o || n.extend(c, n.css(A, ["width", "height"])),
                        n.css(u, c),
                        u.setAttribute(e, ""),
                    ...
                    A.___origStyle = {};
                    var _ = A.style
                        , d = a.concat(["width", "height", "position", "boxSizing", "mozBoxSizing", "webkitBoxSizing"]);
                    d.forEach(function(t) {
                        A.___origStyle[t] = _[t] || ""
                    })
                }
                ...
                this.removePin = function(t) {
                    if (A) {
                        if (_ === h && D(!0),
                            ...
                            A.parentNode.hasAttribute(e) || (n.css(A, A.___origStyle),
            ...
            return f.on("destroy.internal", function(t) {
                ...
                this.setClassToggle = function(t, e) {
                    ...
                    return 0 !== i.length && n.type.String(e) ? (L.length > 0 && f.removeClassToggle(),
                            N = e,
                            L = i,
                            ...
                            f) : (w(1, "ERROR calling method 'setClassToggle()': Invalid " + (0 === i.length ? "element" : "classes") + " supplied."),
                            f)
                }
                ,
    ...
    t.Scene.addOption = function(e, i, n, s) {
        e in r.defaults ? t._util.log(1, "[static] ScrollMagic.Scene -> Cannot add Scene option '" + e + "', because it already exists.") : (r.defaults[e] = i,
                r.validate[e] = n,
            s && r.shifts.push(e))
    }
        ,
        ...
        return d.elements = function(e) {
            ...
            if ("nodelist" === _(e) || _.Array(e))
                for (var n = 0, s = i.length = e.length; n < s; n++) {
                    var a = e[n];
                    i[n] = _.DomElement(a) ? a : d.elements(a)
                }
            else
                (_.DomElement(e) || e === document || e === t) && (i = [e]);
            return i
        }
            ,
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        s.version = "1.19.0",
            ...
            u.render = function(t, e, i) {
                ...
                var r, n, s, l, h, u, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration, _ = this._time, d = this._totalTime, m = this._cycle, g = this._duration, v = this._rawPrevTime;
                if (t >= p - 1e-7 ? (this._totalTime = p,
                        ...
                        (v < 0 || t <= 0 && t >= -1e-7 || v === a && "isPause" !== this.data) && v !== t && (i = !0,
                        v > a && (n = "onReverseComplete")),
                            this._rawPrevTime = f = !e || t || v === t ? t : a)) : t < 1e-7 ? (this._totalTime = this._time = this._cycle = 0,
                                this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0,
                            (0 !== d || 0 === g && v > 0) && (n = "onReverseComplete",
                                r = this._reversed),
                            t < 0 && (this._active = !1,
        ...
        s.killAll = function(t, i, r, n) {
            null == i && (i = !0),
            null == r && (r = !0);
            var s, a, o, l = p(0 != n), h = l.length, u = i && r && n;
            for (o = 0; o < h; o++)
                a = l[o],
                (u || a instanceof e || (s = a.target === a.vars.onComplete) && r || i && !s) && (t ? a.totalTime(a._reversed ? 0 : a.totalDuration()) : a._enabled(!1, !1))
        }
            ,
        ...
        var _ = function(t, i, r, n) {
            i = i !== !1,
                r = r !== !1,
                n = n !== !1;
            for (var s, a, o = p(n), l = i && r && n, h = o.length; --h > -1; )
                a = o[h],
                (l || a instanceof e || (s = a.target === a.vars.onComplete) && r || i && !s) && a.paused(t)
        };
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
            var r = function(t) {
                ...
                for (r in n)
                    i = n[r],
                    l(i) && i.join("").indexOf("{self}") !== -1 && (n[r] = this._swapSelfInParams(i));
                ...
                for (r in s)
                    n = s[r],
                        t[r] = "function" == typeof n ? n.call(e[i], i) : n[i % n.length];
                delete t.cycle
            }
            ...
            return r.version = "1.19.0",
                ...
                r.exportRoot = function(t, e) {
                    ...
                    var n, s, a = new r(t), o = a._timeline;
                    for (null == e && (e = !0),
                             o._remove(a, !0),
                             a._startTime = 0,
                ...
                m.render = function(t, e, i) {
                    ...
                    var r, s, a, o, l, c, f, p = this._dirty ? this.totalDuration() : this._totalDuration, _ = this._time, d = this._startTime, m = this._timeScale, g = this._paused;
                    if (t >= p - 1e-7)
                        this._totalTime = this._time = p,
                        this._reversed || this._hasPausedChild() || (s = !0,
                            o = "onComplete",
                            l = !!this._timeline.autoRemoveChildren,
                        0 === this._duration && (t <= 0 && t >= -1e-7 || this._rawPrevTime < 0 || this._rawPrevTime === n) && this._rawPrevTime !== t && this._first && (l = !0,
                        this._rawPrevTime > n && (o = "onReverseComplete"))),
                            this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : n,
                            t = p + 1e-4;
                    else if (t < 1e-7)
                        if (this._totalTime = this._time = 0,
                            (0 !== _ || 0 === this._duration && this._rawPrevTime !== n && (this._rawPrevTime > 0 || t < 0 && this._rawPrevTime >= 0)) && (o = "onReverseComplete",
                                s = this._reversed),
                            t < 0)
                            this._active = !1,
                    ...
                    if (this._time !== _ && this._first || i || l || c) {
                        if (this._initted || (this._initted = !0),
                            ...
                            f === this._time && (!this._paused || g)); )
                                (r._active || r._startTime <= f && !r._paused && !r._gc) && (c === r && this.pause(),
                ...
                m.getChildren = function(t, e, r, n) {
                    ...
                    for (var s = [], a = this._first, o = 0; a; )
                        a._startTime < n || (a instanceof i ? e !== !1 && (s[o++] = a) : (r !== !1 && (s[o++] = a),
                            t !== !1 && (s = s.concat(a.getChildren(!0, e, r)),
                                o = s.length))),
                            a = a._next;
                    return s
                }
        ...
        _gsScope._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function(t, e, i) {
            ...
            return u.constructor = r,
                ...
                u.render = function(t, e, i) {
                    this._gc && this._enabled(!0, !1);
                    var r, s, l, h, u, c, f, p, _ = this._dirty ? this.totalDuration() : this._totalDuration, d = this._duration, m = this._time, g = this._totalTime, v = this._startTime, y = this._timeScale, T = this._rawPrevTime, w = this._paused, x = this._cycle;
                    if (t >= _ - 1e-7)
                        ...
                        0 === this._duration && (t <= 0 && t >= -1e-7 || T < 0 || T === n) && T !== t && this._first && (u = !0,
                        ...
                        if (this._locked || (this._totalTime = this._cycle = 0),
                                this._time = 0,
                            (0 !== m || 0 === d && T !== n && (T > 0 || t < 0 && T >= 0) && !this._locked) && (h = "onReverseComplete",
                                s = this._reversed),
                            t < 0)
                            this._active = !1,
                                this._timeline.autoRemoveChildren && this._reversed ? (u = s = !0,
                                        h = "onReverseComplete") : T >= 0 && this._first && (u = !0),
                                this._rawPrevTime = t;
                        else {
                ...
                u.getActive = function(t, e, i) {
                    ...
                    null == e && (e = !0),
                    null == i && (i = !1);
                    var r, n, s = [], a = this.getChildren(t, e, i), o = 0, l = a.length;
                    for (r = 0; r < l; r++)
                        n = a[r],
                        n.isActive() && (s[o++] = n);
                    return s
        ...
        function() {
            var t = 180 / Math.PI
                ...
                var h, u, c, f, p, _, d, m, g, v, y, T, w, x = t.length - 1, b = 0, P = t[0].a;
                for (h = 0; h < x; h++)
                    p = t[b],
                        u = p.a,
                        c = p.d,
                        ...
                        o ? (y = e[h],
                                T = i[h],
                                w = (T + y) * n * .25 / (a ? .5 : r[h] || .5),
                                _ = c - (c - u) * (a ? .5 * n : 0 !== y ? w / y : 0),
                                d = c + (f - c) * (a ? .5 * n : 0 !== T ? w / T : 0),
                                m = c - (_ + ((d - _) * (3 * y / (y + T) + .5) / 4 || 0))) : (_ = c - (c - u) * n * .5,
                                d = c + (f - c) * n * .5,
                                m = c - (_ + d) / 2),
                        _ += m,
                        d += m,
                ...
                if (s)
                    for (t = [s].concat(t),
                             l = t.length; --l > -1; )
                        "string" == typeof (f = t[l][r]) && "=" === f.charAt(1) && (t[l][r] = s[r] + Number(f.charAt(0) + f.substr(2)));
                if (o = t.length - 2,
                    o < 0)
                    return p[0] = new a(t[0][r],0,0,t[o < -1 ? 0 : 1][r]),
                        p;
                for (l = 0; l < o; l++)
                    h = t[l][r],
                        u = t[l + 1][r],
                    ...
                    n && (c = t[l + 2][r],
                        e[l] = (e[l] || 0) + (u - h) * (u - h),
                        i[l] = (i[l] || 0) + (c - u) * (c - u));
                return p[l] = new a(t[l][r],0,0,t[l + 1][r]),
                    p
            }
                , c = function(t, s, a, l, c, f) {
                var p, _, d, m, g, v, y, T, w = {}, x = [], b = f || t[0];
                ...
                , f = function(t, e, i) {
                e = e || "soft";
                var r, n, s, o, l, h, u, c, f, p, _, d = {}, m = "cubic" === e ? 3 : 2, g = "soft" === e, v = [];
                if (g && i && (t = [i].concat(t)),
                    null == t || t.length < m + 1)
                ...
                for (h = v.length; --h > -1; ) {
                    for (f = v[h],
                             ...
                             c = t.length,
                             u = 0; u < c; u++)
                        r = null == i ? t[u][f] : "string" == typeof (_ = t[u][f]) && "=" === _.charAt(1) ? i[f] + Number(_.charAt(0) + _.substr(2)) : Number(_),
                        g && u > 1 && u < c - 1 && (l[p++] = (r + l[p - 2]) / 2),
                            l[p++] = r;
                    for (c = p - m + 1,
                             p = 0,
                             u = 0; u < c; u += m)
                        r = l[u],
                            ...
                            s = l[u + 2],
                            o = 2 === m ? 0 : l[u + 3],
                            l[p++] = _ = 3 === m ? new a(r,n,s,o) : new a(r,(2 * n + r) / 3,(2 * n + s) / 3,s);
                    l.length = p
                }
                return d
            }
                ...
                for (var r, n, s, a, o, l, h, u, c, f, p, _ = 1 / i, d = t.length; --d > -1; )
                    for (f = t[d],
                        ...
                        h = _ * u,
                            c = 1 - h,
                            r = n - (n = (h * h * a + 3 * c * (h * o + c * l)) * h),
                            p = d * i + u - 1,
                            e[p] = (e[p] || 0) + r * r
            }
                , _ = function(t, e) {
                e = e >> 0 || 6;
                var i, r, n, s, a = [], o = [], l = 0, h = 0, u = e - 1, c = [], f = [];
                for (i in t)
                    p(t[i], a, e);
                for (n = a.length,
                         r = 0; r < n; r++)
                ...
                init: function(t, e, i) {
                    ...
                    var r, n, s, a, o, l = e.values || [], h = {}, u = l[0], p = e.autoRotate || i.vars.orientToBezier;
                ...
                set: function(e) {
                    var i, r, n, s, a, o, l, h, u, c, f = this._segCount, p = this._func, _ = this._target, d = e !== this._startRatio;
                    if (this._timeRes) {
                        if (u = this._lengths,
                                c = this._curSeg,
                                e *= this._length,
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var u, c, f, p, _, d, m, g, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g, y = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, T = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, w = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, x = /(?:\d|\-|\+|=|#|\.)*/g, b = /opacity *= *([^)]*)/i, P = /opacity:([^;]*)/i, S = /alpha\(opacity *=.+?\)/i, R = /^(rgb|hsl)/, O = /([A-Z])/g, k = /-([a-z])/gi, C = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, A = function(t, e) {
                return e.toUpperCase()
            }, M = /(?:Left|Right|Width)/i, D = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, E = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, F = /,(?=[^\)]*(?:\(|$))/gi, z = /[\s,\(]/i, I = Math.PI / 180, N = 180 / Math.PI, L = {}, X = document, B = function(t) {
                return X.createElementNS ? X.createElementNS("http://www.w3.org/1999/xhtml", t) : X.createElement(t)
            }, j = B("div"), Y = B("img"), U = a._internals = {
                _specialProps: l
            }, q = navigator.userAgent, V = function() {
                var t = q.indexOf("Android")
                    , e = B("a");
                return f = q.indexOf("Safari") !== -1 && q.indexOf("Chrome") === -1 && (t === -1 || Number(q.substr(t + 8, 1)) > 3),
                    _ = f && Number(q.substr(q.indexOf("Version/") + 8, 1)) < 6,
                    p = q.indexOf("Firefox") !== -1,
                ...
                var s;
                return V || "opacity" !== e ? (!r && t.style[e] ? s = t.style[e] : (i = i || Q(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(O, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]),
                        null == n || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : n) : W(t)
            }
                , J = U.convertToPixels = function(t, i, r, n, s) {
                if ("px" === n || !n)
                    return r;
                if ("auto" === n || !r)
                    return 0;
                var o, l, h, u = M.test(i), c = t, f = j.style, p = r < 0, _ = 1 === r;
                if (p && (r = -r),
                    _ && (r *= 100),
                    ...
                    c.appendChild(j),
                        ...
                        c.removeChild(j),
                    u && "%" === n && a.cacheWidths !== !1 && (l = c._gsCache = c._gsCache || {},
                        l.time = h,
                        l.width = o / r * 100),
                    0 !== o || s || (o = J(t, i, r, n, !0))
                }
                ...
                var r = "left" === e ? "Left" : "Top"
                    , n = K(t, "margin" + r, i);
                return t["offset" + r] - (J(t, e, parseFloat(n), n.replace(x, "")) || 0)
            }
                , et = function(t, e) {
                var i, r, n, s = {};
                if (e = e || Q(t, null))
                    if (i = e.length)
                        for (; --i > -1; )
                            n = e[i],
                            n.indexOf("-transform") !== -1 && kt !== n || (s[n.replace(k, A)] = e.getPropertyValue(n));
                    else
                        for (i in e)
                            i.indexOf("Transform") !== -1 && Ot !== i || (s[i] = e[i]);
                else if (e = t.currentStyle || t.style)
                    for (i in e)
                        "string" == typeof i && void 0 === s[i] && (s[i.replace(k, A)] = e[i]);
                return V || (s.opacity = W(t)),
                    r = jt(t, e, !1),
                ...
                for (a in i)
                    "cssText" !== a && "length" !== a && isNaN(a) && (e[a] !== (s = i[a]) || n && n[a]) && a.indexOf("Origin") === -1 && ("number" != typeof s && "string" != typeof s || (l[a] = "auto" !== s || "left" !== a && "top" !== a ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[a] || "" === e[a].replace(w, "") ? s : 0 : tt(t, a),
                ...
                return "function" == typeof t && (t = t(g, m)),
                    null == t ? o = e : "number" == typeof t ? o = t : (n = 360,
                                s = t.split("_"),
                                l = "=" === t.charAt(1),
                                a = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (t.indexOf("rad") === -1 ? 1 : N) - (l ? 0 : e),
                            s.length && (r && (r[i] = e + a),
                            t.indexOf("short") !== -1 && (a %= n,
                            a !== a % (n / 2) && (a = a < 0 ? a + n : a - n)),
                                t.indexOf("_cw") !== -1 && a < 0 ? a = (a + 9999999999 * n) % n - (a / n | 0) * n : t.indexOf("ccw") !== -1 && a > 0 && (a = (a - 9999999999 * n) % n - (a / n | 0) * n)),
                                o = e + a),
                o < h && o > -h && (o = 0),
                    o
            }, ut = {
                ...
                return e && !f && (r = i[0] / 255,
                    ...
                    h === u ? a = o = 0 : (c = h - u,
                            o = l > .5 ? c / (2 - h - u) : c / (h + u),
                            a = h === r ? (n - s) / c + (n < s ? 6 : 0) : h === n ? (s - r) / c + 2 : (r - n) / c + 4,
                            a *= 60),
                    i[0] = a + .5 | 0,
                    i[1] = 100 * o + .5 | 0,
                    i[2] = 100 * l + .5 | 0),
                ...
                , pt = function(t, e) {
                var i, r, n, s = t.match(_t) || [], a = 0, o = s.length ? "" : t;
            ...
            var dt = function(t, e, i, r) {
                if (null == t)
                    return function(t) {
                        ...
                        ;
                var n, s = e ? (t.match(_t) || [""])[0] : "", a = t.split(s).join("").match(T) || [], o = t.substr(0, t.indexOf(a[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "", h = t.indexOf(" ") !== -1 ? " " : ",", u = a.length, c = u > 0 ? a[0].replace(v, "") : "";
                ...
                , vt = (U._parseToProxy = function(t, e, i, r, n, s) {
                    var a, o, l, h, u, c = r, f = {}, p = {}, _ = i._transform, d = L;
                ...
                "function" == typeof r && (r = r(g, m)),
                    o = new vt(t,e,0,0,o,c ? 2 : 1,null,(!1),l,i,r),
                    r += "",
                n && _t.test(r + i) && (r = [i, r],
                    a.colorStringFilter(r),
                    i = r[0],
                    r = r[1]);
                var f, p, _, d, T, w, x, b, P, S, R, O, k, C = i.split(", ").join(",").split(" "), A = r.split(", ").join(",").split(" "), M = C.length, D = u !== !1;
                for (r.indexOf(",") === -1 && i.indexOf(",") === -1 || (C = C.join(" ").replace(F, ", ").split(" "),
                    A = A.join(" ").replace(F, ", ").split(" "),
                    M = C.length),
                     M !== A.length && (C = (s || "").split(" "),
                         M = C.length),
                         o.plugin = h,
                         o.setRatio = c,
                         _t.lastIndex = 0,
                    ...
                    if (d = C[f],
                            ...
                            b = parseFloat(d),
                        b || 0 === b)
                        o.appendXtra("", b, ot(T, b), T.replace(y, ""), D && T.indexOf("px") !== -1, !0);
                    else if (n && _t.test(d))
                        O = T.indexOf(")") + 1,
                            O = ")" + (O ? T.substr(O) : ""),
                            k = T.indexOf("hsl") !== -1 && V,
                            ...
                            P && !V && 0 === T[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent",
                                    o.e = o.e.split(A[f]).join("transparent")) : (V || (P = !1),
                                    k ? o.appendXtra(P ? "hsla(" : "hsl(", d[0], ot(T[0], d[0]), ",", !1, !0).appendXtra("", d[1], ot(T[1], d[1]), "%,", !1).appendXtra("", d[2], ot(T[2], d[2]), P ? "%," : "%" + O, !1) : o.appendXtra(P ? "rgba(" : "rgb(", d[0], T[0] - d[0], ",", !0, !0).appendXtra("", d[1], T[1] - d[1], ",", !0).appendXtra("", d[2], T[2] - d[2], P ? "," : O, !0),
                                P && (d = d.length < 4 ? 1 : d[3],
                                    o.appendXtra("", d, (T.length < 4 ? 1 : T[3]) - d, O, !1))),
                            _t.lastIndex = 0;
                    else if (w = d.match(v)) {
                        if (x = T.match(y),
                            !x || x.length !== w.length)
                        ...
                        for (_ = 0,
                            ...
                            R = w[p],
                                S = d.indexOf(R, _),
                                o.appendXtra(d.substr(_, S - _), Number(R), ot(x[p], R), "", D && "px" === d.substr(S + R.length, 2), 0 === p),
                                _ = S + R.length;
                        o["xs" + o.l] += d.substr(_)
                    } else
                    ...
                    return a["xs" + o] += s && (o || a["xs" + o]) ? " " + t : t || "",
                        i || 0 === o || a.plugin ? (a.l++,
                                ...
                                o > 0 ? (a.data["xn" + o] = e + i,
                                        a.rxp["xn" + o] = n,
                                        a["xn" + o] = e,
                                    a.plugin || (a.xfirst = new vt(a,"xn" + o,e,i,a.xfirst || a,0,a.n,n,a.pr),
                                        a.xfirst.xs0 = 0),
                                        a) : (a.data = {
                                        s: e + i
                                    },
                        ...
                        bt(t, {
                            parser: function(t, i, r, n, s, a, h) {
                                ...
                                return u ? (u._cssRegister(),
                                        l[r].parse(t, i, r, n, s, a, h)) : (G("Error: " + e + " js file not loaded."),
                                        s)
                            }
                        })
                    }
            ...
            h = xt.prototype,
                h.parseComplex = function(t, e, i, r, n, s) {
                    ...
                    if (this.multi && (F.test(i) || F.test(e) ? (o = e.replace(F, "|").split("|"),
                                l = i.replace(F, "|").split("|")) : f && (o = [e],
                                l = [i])),
                            l) {
                        for (h = l.length > o.length ? l.length : o.length,
                            ...
                            f && (u = e.indexOf(f),
                                c = i.indexOf(f),
                            u !== c && (c === -1 ? o[a] = o[a].split(f).join("") : u === -1 && (o[a] += " " + f)));
                        e = o.join(", "),
                            i = l.join(", ")
                    }
            ...
            var St, Rt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Ot = H("transform"), kt = $ + "transform", Ct = H("transformOrigin"), At = null !== H("perspective"), Mt = U.Transform = function() {
                    this.perspective = parseFloat(a.defaultTransformPerspective) || 0,
                        this.force3D = !(a.defaultForce3D === !1 || !At) && (a.defaultForce3D || "auto")
                }
                , Dt = window.SVGElement, Et = function(t, e, i) {
                    ...
                    return e.appendChild(n),
                        n
                }, Ft = X.documentElement, zt = function() {
                    var t, e, i, r = d || /Android/i.test(q) && !window.chrome;
                    return X.createElementNS && !r && (t = Et("svg", Ft),
                        e = Et("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        ...
                        r = i === e.getBoundingClientRect().width && !(p && At),
                        Ft.removeChild(t)),
                        r
                }(), It = function(t, e, i, r, n, s) {
                    var o, l, h, u, c, f, p, _, d, m, g, v, y, T, w = t._gsTransform, x = Bt(t, !0);
                    w && (y = w.xOrigin,
                        T = w.yOrigin),
                    ...
                    w && (s && (i.xOffset = w.xOffset,
                        i.yOffset = w.yOffset,
                        w = i),
                        n || n !== !1 && a.defaultSmoothOrigin !== !1 ? (l = u - y,
                                h = c - T,
                    ...
                    return !!(Dt && t.getBBox && t.getCTM && Nt(t) && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM))
                }, Xt = [1, 0, 0, 1, 0, 0], Bt = function(t, e) {
                    var i, r, n, s, a, o, l = t._gsTransform || new Mt, h = 1e5, u = t.style;
                    if (Ot ? r = K(t, kt, null, !0) : t.currentStyle && (r = t.currentStyle.filter.match(D),
                        ...
                        i && Ot && ((o = "none" === Q(t).display) || !t.parentNode) && (o && (s = u.display,
                            u.display = "block"),
                        t.parentNode || (a = 1,
                            Ft.appendChild(t)),
                            r = K(t, kt, null, !0),
                        ...
                        a && Ft.removeChild(t)),
                        (l.svg || t.getBBox && Lt(t)) && (i && (u[Ot] + "").indexOf("matrix") !== -1 && (r = u[Ot],
                            i = 0),
                    ...
                    for (n = (r || "").match(v) || [],
                             wt = n.length; --wt > -1; )
                        s = Number(n[wt]),
                            n[wt] = (a = s - (s |= 0)) ? (a * h + (a < 0 ? -.5 : .5) | 0) / h + s : s;
                    return e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n
                }, jt = U.getTransform = function(t, i, r, n) {
                    if (t._gsTransform && r && !n)
                        return t._gsTransform;
                    var s, o, l, h, u, c, f = r ? t._gsTransform || new Mt : new Mt, p = f.scaleX < 0, _ = 2e-5, d = 1e5, m = At ? parseFloat(K(t, Ct, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0, g = parseFloat(a.defaultTransformPerspective) || 0;
                    if (f.svg = !(!t.getBBox || !Lt(t)),
                        f.svg && (It(t, K(t, Ct, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")),
                            St = a.useSVGTransformAttr || zt),
                            s = Bt(t),
                        s !== Xt) {
                        if (16 === s.length) {
                            var v, y, T, w, x, b = s[0], P = s[1], S = s[2], R = s[3], O = s[4], k = s[5], C = s[6], A = s[7], M = s[8], D = s[9], E = s[10], F = s[12], z = s[13], I = s[14], L = s[11], X = Math.atan2(C, E);
                            f.zOrigin && (I = -f.zOrigin,
                                F = M * I - s[12],
                                z = D * I - s[13],
                                I = E * I + f.zOrigin - s[14]),
                                f.rotationX = X * N,
                            X && (w = Math.cos(-X),
                                x = Math.sin(-X),
                                v = O * w + M * x,
                            ...
                            f.rotationX && Math.abs(f.rotationX) + Math.abs(f.rotation) > 359.9 && (f.rotationX = f.rotation = 0,
                                ...
                                f.scaleX = (Math.sqrt(b * b + P * P) * d + .5 | 0) / d,
                                f.scaleY = (Math.sqrt(k * k + D * D) * d + .5 | 0) / d,
                                f.scaleZ = (Math.sqrt(C * C + E * E) * d + .5 | 0) / d,
                                f.rotationX || f.rotationY ? f.skewX = 0 : (f.skewX = O || k ? Math.atan2(O, k) * N + f.rotation : f.skewX || 0,
                        ...
                        } else if (!At || n || !s.length || f.x !== s[4] || f.y !== s[5] || !f.rotationX && !f.rotationY) {
                            var B = s.length >= 6
                                , j = B ? s[0] : 1
                                , Y = s[1] || 0
                                , U = s[2] || 0
                            ...
                            f.x = s[4] || 0,
                                ...
                                l = Math.sqrt(j * j + Y * Y),
                                h = Math.sqrt(q * q + U * U),
                                u = j || Y ? Math.atan2(Y, j) * N : f.rotation || 0,
                                c = U || q ? Math.atan2(U, q) * N + u : f.skewX || 0,
                            ...
                            At && (f.rotationX = f.rotationY = f.z = 0,
                                f.perspective = g,
                                f.scaleZ = 1),
                            f.svg && (f.x -= f.xOrigin - (f.xOrigin * j + f.yOrigin * U),
                                f.y -= f.yOrigin - (f.xOrigin * Y + f.yOrigin * q))
                        }
                        f.zOrigin = m;
                        for (o in f)
                            f[o] < _ && f[o] > -_ && (f[o] = 0)
                    ...
                    f.svg && (St && t.style[Ot] ? e.delayedCall(.001, function() {
                            Vt(t.style, Ot)
                ...
                , Yt = function(t) {
                    var e, i, r = this.data, n = -r.rotation * I, s = n + r.skewX * I, a = 1e5, o = (Math.cos(n) * r.scaleX * a | 0) / a, l = (Math.sin(n) * r.scaleX * a | 0) / a, h = (Math.sin(s) * -r.scaleY * a | 0) / a, u = (Math.cos(s) * r.scaleY * a | 0) / a, c = this.t.style, f = this.t.currentStyle;
                    if (f) {
                        i = l,
                            l = -h,
                            h = -i,
                            e = f.filter,
                            c.filter = "";
                        var p, _, m = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== f.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + o + ", M12=" + l + ", M21=" + h + ", M22=" + u, T = r.x + m * r.xPercent / 100, w = r.y + g * r.yPercent / 100;
                        if (null != r.ox && (p = (r.oxp ? m * r.ox * .01 : r.ox) - m / 2,
                                _ = (r.oyp ? g * r.oy * .01 : r.oy) - g / 2,
                                T += p - (p * o + _ * l),
                                w += _ - (p * h + _ * u)),
                                v ? (p = m / 2,
                                        _ = g / 2,
                                        y += ", Dx=" + (p - (p * o + _ * l) + T) + ", Dy=" + (_ - (p * h + _ * u) + w) + ")") : y += ", sizingMethod='auto expand')",
                                e.indexOf("DXImageTransform.Microsoft.Matrix(") !== -1 ? c.filter = e.replace(E, y) : c.filter = y + " " + e,
                            0 !== t && 1 !== t || 1 === o && 0 === l && 0 === h && 1 === u && (v && y.indexOf("Dx=0, Dy=0") === -1 || b.test(e) && 100 !== parseFloat(RegExp.$1) || e.indexOf(e.indexOf("Alpha")) === -1 && c.removeAttribute("filter")),
                                !v) {
                            var P, S, R, O = d < 8 ? 1 : -1;
                            for (p = r.ieOffsetX || 0,
                                     _ = r.ieOffsetY || 0,
                                     r.ieOffsetX = Math.round((m - ((o < 0 ? -o : o) * m + (l < 0 ? -l : l) * g)) / 2 + T),
                                     r.ieOffsetY = Math.round((g - ((u < 0 ? -u : u) * g + (h < 0 ? -h : h) * m)) / 2 + w),
                                     wt = 0; wt < 4; wt++)
                                S = nt[wt],
                                    P = f[S],
                                    i = P.indexOf("px") !== -1 ? parseFloat(P) : J(this.t, S, parseFloat(P), P.replace(x, "")) || 0,
                                    R = i !== r[S] ? wt < 2 ? -r.ieOffsetX : -r.ieOffsetY : wt < 2 ? p - r.ieOffsetX : _ - r.ieOffsetY,
                                    c[S] = (r[S] = Math.round(i - R * (0 === wt || 2 === wt ? 1 : O))) + "px"
                        }
                    }
                }, Ut = U.set3DTransformRatio = U.setTransformRatio = function(t) {
                    var e, i, r, n, s, a, o, l, h, u, c, f, _, d, m, g, v, y, T, w, x, b, P, S = this.data, R = this.t.style, O = S.rotation, k = S.rotationX, C = S.rotationY, A = S.scaleX, M = S.scaleY, D = S.scaleZ, E = S.x, F = S.y, z = S.z, N = S.svg, L = S.perspective, X = S.force3D;
                    if (((1 === t || 0 === t) && "auto" === X && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !X) && !z && !L && !C && !k && 1 === D || St && N || !At)
                        return void (O || S.skewX || N ? (O *= I,
                                b = S.skewX * I,
                                P = 1e5,
                                e = Math.cos(O) * A,
                                n = Math.sin(O) * A,
                                i = Math.sin(O - b) * -M,
                                s = Math.cos(O - b) * M,
                            b && "simple" === S.skewType && (v = Math.tan(b - S.skewY * I),
                                v = Math.sqrt(1 + v * v),
                                i *= v,
                                s *= v,
                            S.skewY && (v = Math.tan(S.skewY * I),
                                v = Math.sqrt(1 + v * v),
                                e *= v,
                                n *= v)),
                            N && (E += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset,
                                F += S.yOrigin - (S.xOrigin * n + S.yOrigin * s) + S.yOffset,
                            St && (S.xPercent || S.yPercent) && (d = this.t.getBBox(),
                                E += .01 * S.xPercent * d.width,
                                F += .01 * S.yPercent * d.height),
                                d = 1e-6,
                            E < d && E > -d && (E = 0),
                            F < d && F > -d && (F = 0)),
                                T = (e * P | 0) / P + "," + (n * P | 0) / P + "," + (i * P | 0) / P + "," + (s * P | 0) / P + "," + E + "," + F + ")",
                                N && St ? this.t.setAttribute("transform", "matrix(" + T) : R[Ot] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + T) : R[Ot] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + A + ",0,0," + M + "," + E + "," + F + ")");
                    if (p && (d = 1e-4,
                        A < d && A > -d && (A = D = 2e-5),
                        M < d && M > -d && (M = D = 2e-5),
                        ...
                        S.skewX && (O -= S.skewX * I,
                            m = Math.cos(O),
                            g = Math.sin(O),
                        "simple" === S.skewType && (v = Math.tan((S.skewX - S.skewY) * I),
                            v = Math.sqrt(1 + v * v),
                            m *= v,
                            g *= v,
                        S.skewY && (v = Math.tan(S.skewY * I),
                        ...
                        if (!(C || k || 1 !== D || L || N))
                            return void (R[Ot] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + E + "px," + F + "px," + z + "px)" + (1 !== A || 1 !== M ? " scale(" + A + "," + M + ")" : ""));
                        e = s = 1,
                            i = n = 0
                    }
                    h = 1,
                    ...
                    z < d && z > -d && (z = 0)),
                        ...
                        T += (e < d && e > -d ? x : e) + w + (n < d && n > -d ? x : n) + w + (o < d && o > -d ? x : o),
                        T += w + (u < d && u > -d ? x : u) + w + (i < d && i > -d ? x : i) + w + (s < d && s > -d ? x : s),
                        k || C || 1 !== D ? (T += w + (l < d && l > -d ? x : l) + w + (c < d && c > -d ? x : c) + w + (r < d && r > -d ? x : r),
                                T += w + (a < d && a > -d ? x : a) + w + (h < d && h > -d ? x : h) + w + (f < d && f > -d ? x : f) + w) : T += ",0,0,0,0,1,0,",
                        T += E + w + F + w + z + w + (L ? 1 + -z / L : 1) + ")",
                        R[Ot] = T
                }
                ;
            h = Mt.prototype,
                ...
                bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, r, s, o, l) {
                        ...
                        "function" == typeof l[i] && (h = l[i],
                            l[i] = e);
                        var u, c, f, p, _, d, v, y, T, w = t._gsTransform, x = t.style, b = 1e-6, P = Rt.length, S = l, R = {}, O = "transformOrigin", k = jt(t, n, !0, S.parseTransform), C = S.transform && ("function" == typeof S.transform ? S.transform(g, m) : S.transform);
                        if (r._transform = k,
                            ...
                            (S.transformOrigin || S.svgOrigin) && (C = {},
                                It(t, at(S.transformOrigin), C, S.svgOrigin, S.smoothOrigin, !0),
                                d = C.xOrigin,
                                v = C.yOrigin,
                            ...
                            if (u = {
                                ...
                                if ("object" == typeof _)
                                    ...
                                    S.rotation = _;
                            "string" == typeof S.x && S.x.indexOf("%") !== -1 && (u.x = 0,
                                u.xPercent = lt(S.x, k.xPercent)),
                            "string" == typeof S.y && S.y.indexOf("%") !== -1 && (u.y = 0,
                                u.yPercent = lt(S.y, k.yPercent)),
                                u.rotation = ht("rotation"in S ? S.rotation : "shortRotation"in S ? S.shortRotation + "_short" : "rotationZ"in S ? S.rotationZ : k.rotation - k.skewY, k.rotation - k.skewY, "rotation", R),
                            At && (u.rotationX = ht("rotationX"in S ? S.rotationX : "shortRotationX"in S ? S.shortRotationX + "_short" : k.rotationX || 0, k.rotationX, "rotationX", R),
                                u.rotationY = ht("rotationY"in S ? S.rotationY : "shortRotationY"in S ? S.shortRotationY + "_short" : k.rotationY || 0, k.rotationY, "rotationY", R)),
                                u.skewX = ht(S.skewX, k.skewX - k.skewY),
                            (u.skewY = ht(S.skewY, k.skewY)) && (u.skewX += u.skewY,
                                u.rotation += u.skewY)
                        }
                        for (At && null != S.force3D && (k.force3D = S.force3D,
                            p = !0),
                                 k.skewType = S.skewType || k.skewType || a.defaultSkewType,
                                 f = k.force3D || k.z || k.rotationX || k.rotationY || u.z || u.rotationX || u.rotationY || u.perspective,
                             f || null == S.scale || (u.scaleZ = 1); --P > -1; )
                            T = Rt[P],
                                C = u[T] - k[T],
                            (C > b || C < -b || null != S[T] || null != L[T]) && (p = !0,
                                s = new vt(k,T,k[T],C,s),
                            T in R && (s.e = R[T]),
                                s.xs0 = 0,
                                s.plugin = o,
                                r._overwriteProps.push(s.n));
                        return C = S.transformOrigin,
                        k.svg && (C || S.svgOrigin) && (d = k.xOffset,
                            v = k.yOffset,
                            It(t, at(C), u, S.svgOrigin, S.smoothOrigin),
                            s = yt(k, "xOrigin", (w ? k : u).xOrigin, u.xOrigin, s, O),
                            s = yt(k, "yOrigin", (w ? k : u).yOrigin, u.yOrigin, s, O),
                        d === k.xOffset && v === k.yOffset || (s = yt(k, "xOffset", w ? d : k.xOffset, k.xOffset, s, O),
                            s = yt(k, "yOffset", w ? v : k.yOffset, k.yOffset, s, O)),
                            C = St ? null : "0px 0px"),
                        (C || At && f && k.zOrigin) && (Ot ? (p = !0,
                                T = Ct,
                                C = (C || K(t, T, n, !1, "50% 50%")) + "",
                                s = new vt(x,T,0,0,s,(-1),O),
                                s.b = x[T],
                                s.plugin = o,
                                At ? (c = k.zOrigin,
                                        C = C.split(" "),
                                        k.zOrigin = (C.length > 2 && (0 === c || "0px" !== C[2]) ? parseFloat(C[2]) : c) || 0,
                                        s.xs0 = s.e = C[0] + " " + (C[1] || "50%") + " 0px",
                                        s = new vt(k,"zOrigin",0,0,s,(-1),s.n),
                                        s.b = c,
                                        s.xs0 = s.e = k.zOrigin) : s.xs0 = s.e = C) : at(C + "", k)),
                        p && (r._transformType = k.svg && St || !f && 3 !== this._transformType ? 2 : 3),
                        h && (l[i] = h),
                            s
                    },
                    prefix: !0
                ...
                bt("borderRadius", {
                    ...
                    parser: function(t, e, i, s, a, o) {
                        e = this.format(e);
                        var l, h, u, c, f, p, _, d, m, g, v, y, T, w, x, b, P = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], S = t.style;
                        for (m = parseFloat(t.offsetWidth),
                            ...
                            f.indexOf(" ") !== -1 && (c = f.split(" "),
                                ...
                                y = f.substr((_ + "").length),
                                T = "=" === p.charAt(1),
                                T ? (d = parseInt(p.charAt(0) + "1", 10),
                                        p = p.substr(2),
                                        d *= parseFloat(p),
                                        v = p.substr((d + "").length - (d < 0 ? 1 : 0)) || "") : (d = parseFloat(p),
                                        v = p.substr((d + "").length)),
                            "" === v && (v = r[i] || y),
                            v !== y && (w = J(t, "borderLeft", _, y),
                                x = J(t, "borderTop", _, y),
                                "%" === v ? (f = w / m * 100 + "%",
                                        c = x / g * 100 + "%") : "em" === v ? (b = J(t, "borderLeft", 1, "em"),
                                            f = w / b + "em",
                                            c = x / b + "em") : (f = w + "px",
                                            c = x + "px"),
                            T && (p = parseFloat(f) + d + v,
                                u = parseFloat(c) + d + v)),
                                a = Tt(S, P[h], f + " " + c, p + " " + u, !1, "0px", a);
                        return a
                    },
                    prefix: !0,
                ...
                bt("backgroundPosition", {
                    defaultValue: "0 0",
                    parser: function(t, e, i, r, s, a) {
                        var o, l, h, u, c, f, p = "background-position", _ = n || Q(t, null), m = this.format((_ ? d ? _.getPropertyValue(p + "-x") + " " + _.getPropertyValue(p + "-y") : _.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                        if (m.indexOf("%") !== -1 != (g.indexOf("%") !== -1) && g.split(",").length < 2 && (f = K(t, "backgroundImage").replace(C, ""),
                            f && "none" !== f)) {
                            for (o = m.split(" "),
                                     l = g.split(" "),
                ...
                bt("clip", {
                    ...
                    parser: function(t, e, i, r, s, a) {
                        ...
                        return d < 9 ? (l = t.currentStyle,
                                ...
                                e = this.format(e).split(",").join(h)) : (o = this.format(K(t, this.p, n, !1, this.dflt)),
                                e = this.format(e)),
                ...
                bt("border", {
                    ...
                    parser: function(t, e, i, r, s, a) {
                        ...
                        return "px" !== h && (o = parseFloat(o) / J(t, "borderTopWidth", 1, h) + h),
                            this.parseComplex(t.style, this.format(o + " " + K(t, "borderTopStyle", n, !1, "solid") + " " + K(t, "borderTopColor", n, !1, "#000")), l.join(" "), s, a)
                    },
                    color: !0,
                    formatter: function(t) {
                        var e = t.split(" ");
            ...
            var qt = function(t) {
                ...
                100 === n && (r.indexOf("atrix(") === -1 && r.indexOf("radient(") === -1 && r.indexOf("oader(") === -1 ? (i.removeAttribute("filter"),
                        e = !K(this.data, "filter")) : (i.filter = r.replace(S, ""),
                        e = !0)),
                e || (this.xn1 && (i.filter = r = r || "alpha(opacity=" + n + ")"),
                    r.indexOf("pacity") === -1 ? 0 === n && this.xn1 || (i.filter = r + " alpha(opacity=" + n + ")") : i.filter = r.replace(b, "opacity=" + n))
            };
            bt("opacity,alpha,autoAlpha", {
                ...
                parser: function(t, e, i, r, s, a) {
                    ...
                    h && 1 === o && "hidden" === K(t, "visibility", n) && 0 !== e && (o = 0),
                        V ? s = new vt(l,"opacity",o,e - o,s) : (s = new vt(l,"opacity",100 * o,100 * (e - o),s),
                                s.xn1 = h ? 1 : 0,
                                l.zoom = 1,
                                s.type = 2,
            ...
            bt("className", {
                parser: function(t, e, r, s, a, o, l) {
                    ...
                    if (a = s._classNamePT = new vt(t,r,0,0,a,2),
                            a.setRatio = Wt,
                            a.pr = -11,
                            i = !0,
                            a.b = _,
                ...
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e)
                        ...
                        for (e = this.e.split(" ").join("").split(","),
                                 r = e.length; --r > -1; )
                            i = e[r],
                            l[i] && (l[i].parse === o ? n = !0 : i = "transformOrigin" === i ? Ct : l[i].p),
                                Vt(a, i);
                    n && (Vt(a, Ot),
            ...
            h = a.prototype,
                ...
                h._onInitTween = function(t, e, o, h) {
                    ...
                    if (c && "" === R.zIndex && (p = K(t, "zIndex", n),
                        "auto" !== p && "" !== p || this._addLazySet(R, "zIndex", 0)),
                        "string" == typeof e && (y = R.cssText,
                            p = et(t, n),
                            R.cssText = y + ";" + e,
                            p = it(t, p, et(t)).difs,
                        !V && P.test(e) && (p.opacity = parseFloat(RegExp.$1)),
                            e = p,
                            R.cssText = y),
                        ...
                        for (S = 3 === this._transformType,
                                 Ot ? f && (c = !0,
                                     "" === R.zIndex && (x = K(t, "zIndex", n),
                                     "auto" !== x && "" !== x || this._addLazySet(R, "zIndex", 0)),
                                     _ && this._addLazySet(R, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (S ? "visible" : "hidden"))) : R.zoom = 1,
                                 v = d; v && v._next; )
                            v = v._next;
                        b = new vt(t,"transform",0,0,null,2),
                            this._linkCSSP(b, null, v),
                            b.setRatio = Ot ? Ut : Yt,
                            b.data = this._transform || jt(t, n, !0),
                            b.tween = o,
                            b.pr = -1,
                            s.pop()
                    }
                ...
                h.parse = function(t, e, i, s) {
                    ...
                    for (a in e)
                        ...
                        "function" == typeof p && (p = p(g, m)),
                            o = l[a],
                            o ? i = o.parse(t, p, a, this, i, s, e) : (f = K(t, a, n) + "",
                                    v = "string" == typeof p,
                                    "color" === a || "fill" === a || "stroke" === a || a.indexOf("Color") !== -1 || v && R.test(p) ? (v || (p = ft(p),
                                            p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                                            i = Tt(T, a, f, p, !0, "transparent", i, 0, s)) : v && z.test(p) ? i = Tt(T, a, f, p, !0, null, i, 0, s) : (h = parseFloat(f),
                                                _ = h || 0 === h ? f.substr((h + "").length) : "",
                                            "" !== f && "auto" !== f || ("width" === a || "height" === a ? (h = st(t, a, n),
                                                    _ = "px") : "left" === a || "top" === a ? (h = tt(t, a, n),
                                                ...
                                                y ? (c = parseInt(p.charAt(0) + "1", 10),
                                                        p = p.substr(2),
                                                        c *= parseFloat(p),
                                                        d = p.replace(x, "")) : (c = parseFloat(p),
                                                        d = v ? p.replace(x, "") : ""),
                                            "" === d && (d = a in r ? r[a] : _),
                                                p = c || 0 === c ? (y ? c + h : c) + d : e[a],
                                            _ !== d && "" !== d && (c || 0 === c) && h && (h = J(t, a, h, _),
                                                "%" === d ? (h /= J(t, a, 100, "%") / 100,
                                                    e.strictUnits !== !0 && (f = h + "%")) : "em" === d || "rem" === d || "vw" === d || "vh" === d ? h /= J(t, a, 1, d) : "px" !== d && (c = J(t, a, c, d),
                                                            d = "px"),
                                            y && (c || 0 === c) && (p = c + h + d)),
                                            y && (c += h),
                                                !h && 0 !== h || !c && 0 !== c ? void 0 !== T[a] && (p || p + "" != "NaN" && null != p) ? (i = new vt(T,a,c || h || 0,0,i,(-1),a,(!1),0,f,p),
                                                            i.xs0 = "none" !== p || "display" !== a && a.indexOf("Style") === -1 ? p : f) : G("invalid " + a + " tween value: " + e[a]) : (i = new vt(T,a,h,c - h,i,0,a,u !== !1 && ("px" === d || "zIndex" === a),0,f,p),
                                                        i.xs0 = d))),
            ...
            var Zt = function(t, e, i) {
                ...
                if (t.slice)
                    ...
                    for (r = t.childNodes,
                        ...
                        s.style && (e.push(et(s)),
                        i && i.push(s)),
                        1 !== a && 9 !== a && 11 !== a || !s.childNodes.length || Zt(s, e, i)
            };
            return a.cascadeTo = function(t, i, r) {
                var n, s, a, o, l = e.to(t, i, r), h = [l], u = [], c = [], f = [], p = e._internals.reservedProps;
        ...
        function() {
            ...
            i._onInitAllProps = function() {
                for (var t, i, r, n = this._tween, s = n.vars.roundProps.join ? n.vars.roundProps : n.vars.roundProps.split(","), a = s.length, o = {}, l = n._propLookup.roundProps; --a > -1; )
                    o[s[a]] = Math.round;
                for (a = s.length; --a > -1; )
                    for (t = s[a],
                             i = n._firstPT; i; )
        ...
        _gsScope._gsDefine.plugin({
            ...
            init: function(t, e, i, r) {
                "object" != typeof e && (e = {
                    ...
                    this.finals = {};
                var n, s, a, o, l, h, u = e.useRadians === !0 ? 2 * Math.PI : 360, c = 1e-6;
                for (n in e)
                    "useRadians" !== n && (o = e[n],
                    "function" == typeof o && (o = o(r, t)),
                        ...
                        l = o - a,
                    h.length && (s = h.join("_"),
                    s.indexOf("short") !== -1 && (l %= u,
                    l !== l % (u / 2) && (l = l < 0 ? l + u : l - u)),
                        s.indexOf("_cw") !== -1 && l < 0 ? l = (l + 9999999999 * u) % u - (l / u | 0) * u : s.indexOf("ccw") !== -1 && l > 0 && (l = (l - 9999999999 * u) % u - (l / u | 0) * u)),
                    (l > c || l < -c) && (this._addTween(t, n, a, a + l, n),
                        this._overwriteProps.push(n)));
                return !0
            },
            set: function(t) {
        ...
        _gsScope._gsDefine("easing.Back", ["easing.Ease"], function(t) {
            var e, i, r, n = _gsScope.GreenSockGlobals || _gsScope, s = n.com.greensock, a = 2 * Math.PI, o = Math.PI / 2, l = s._class, h = function(e, i) {
            ...
            return m.constructor = d,
                ...
                i = l("easing.RoughEase", function(e) {
                    e = e || {};
                    for (var i, r, n, s, a, o, l = e.taper || "none", h = [], u = 0, c = 0 | (e.points || 20), p = c, _ = e.randomize !== !1, d = e.clamp === !0, m = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --p > -1; )
                        i = _ ? Math.random() : 1 / c * p,
                            ...
                            "none" === l ? n = g : "out" === l ? (s = 1 - i,
                                        n = s * s * g) : "in" === l ? n = i * i * g : i < .5 ? (s = 2 * i,
                                                n = s * s * .5 * g) : (s = 2 * (1 - i),
                                                n = s * s * .5 * g),
                            _ ? r += Math.random() * n - .5 * n : p % 2 ? r += .5 * n : r -= .5 * n,
                        d && (r > 1 ? r = 1 : r < 0 && (r = 0)),
                            h[u++] = {
                                x: i,
                                y: r
...
_gsScope._gsDefine && _gsScope._gsQueue.pop()(),
        ...
        if (!r.TweenLite) {
            var n, s, a, o, l, h = function(t) {
                    ...
                    for (e = 0; e !== r; i.push(t[e++]))
                        ;
                    return i
                }, p = function() {}, _ = function() {
                    var t = Object.prototype.toString
                        , e = t.call([]);
                    return function(i) {
                        return null != i && (i instanceof Array || "object" == typeof i && !!i.push && t.call(i) === e)
                    }
                }(), d = {}, m = function(n, s, a, o) {
                    this.sc = d[n] ? d[n].sc : [],
                        d[n] = this,
                        this.gsClass = null,
                        this.func = a;
                ...
                , x = T.register = function(t, e, i, r) {
                    for (var n, s, a, o, l = e.split(","), h = l.length, c = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1; )
                        for (s = l[h],
                                 ...
                                 a = c.length; --a > -1; )
                            o = c[a],
                                w[s + "." + o] = w[o + s] = n[o] = t.getRatio ? t : t[o] || new t
                }
                ;
            for (a = T.prototype,
                     a._calcEnd = !1,
                     ...
                     s = n.length; --s > -1; )
                a = n[s] + ",Power" + s,
                    x(new T(null,null,1,s), a, "easeOut", !0),
                    x(new T(null,null,2,s), a, "easeIn" + (0 === s ? ",easeNone" : "")),
                    x(new T(null,null,3,s), a, "easeInOut");
            ...
            a = b.prototype,
                a.addEventListener = function(t, e, i, r, n) {
                    n = n || 0;
                    ...
                    for (this !== o || l || o.wake(),
                         null == h && (this._listeners[t] = h = []),
                             a = h.length; --a > -1; )
                        s = h[a],
                            s.c === e && s.s === i ? h.splice(a, 1) : 0 === u && s.pr < n && (u = a + 1);
                    h.splice(u, 0, {
                        c: e,
                        s: i,
                        up: r,
            ...
            v("Ticker", function(t, e) {
                var i, r, n, s, a, h = this, u = R(), f = !(e === !1 || !P) && "auto", _ = 500, d = 33, m = "tick", g = function(t) {
                    var e, o, l = R() - O;
                    l > _ && (u += l - d),
                        O += l,
                        h.time = (O - u) / 1e3,
                ...
                b.call(h),
                    ...
                    ,
                    h.wake = function(t) {
                        null !== n ? h.sleep() : t ? u += -O + (O = R()) : h.frame > 10 && (O = R() - _ + 5),
                            r = 0 === i ? p : f && P ? P : function(t) {
            ...
            var M = v("TweenLite", function(e, i, r) {
                ...
                if (this._overwrite = l = null == l ? V[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : V[l],
                    ...
                    for (this._targets = a = f(e),
                             ...
                             n = 0; n < a.length; n++)
                        s = a[n],
                            s ? "string" != typeof s ? s.length && s !== t && s[0] && (s[0] === t || s[0].nodeType && s[0].style && !s.nodeType) ? (a.splice(n--, 1),
                                            this._targets = a = a.concat(f(s))) : (this._siblings[n] = H(s, this, !1),
                                        1 === l && this._siblings[n].length > 1 && K(s, this, null, 1, this._siblings[n])) : (s = a[n--] = M.selector(s),
                ...
                var i, r = {};
                for (i in t)
                    q[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!j[i] || j[i] && j[i]._autoCSS) || (r[i] = t[i],
                        delete t[i]);
                t.css = r
            };
            a = M.prototype = new k,
            ...
            var F = []
                ...
                , N = function(t) {
                    for (var e, i = this._firstPT, r = 1e-6; i; )
                        e = i.blob ? t ? this.join("") : this.start : i.c * t + i.s,
                            i.m ? e = i.m(e, this._target || i.t) : e < r && e > -r && (e = 0),
                            i.f ? i.fp ? i.t[i.p](i.fp, e) : i.t[i.p](e) : i.t[i.p] = e,
                            i = i._next
                }
                , L = function(t, e, i, r) {
                    var n, s, a, o, l, h, u, c = [t, e], f = 0, p = "", _ = 0;
                    for (c.start = t,
                         i && (i(c),
                             t = c[0],
                             e = c[1]),
                ...
                , X = function(t, e, i, r, n, s, a, o, l) {
                    ...
                    var h, u, c = "get" === i ? t[e] : i, f = typeof t[e], p = "string" == typeof r && "=" === r.charAt(1), _ = {
                        t: t,
                        p: e,
                        s: c,
                        f: "function" === f,
                    ...
                    if ("number" !== f && ("function" === f && "get" === i && (u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3),
                            _.s = c = a ? t[u](a) : t[u]()),
                            "string" == typeof c && (a || isNaN(c)) ? (_.fp = a,
                                    h = L(c, r, o || M.defaultStringFilter, _),
                                    _ = {
                                        t: h,
                                        p: "setRatio",
                                        s: 0,
                ...
                , W = k._rootFramesTimeline = new A
                , G = k._rootTimeline = new A
                , $ = 30
            ...
            G._startTime = o.time,
                ...
                k._updateRoot = M.render = function() {
                    ...
                    if (F.length && Z(),
                        ...
                        F.length && Z(),
                        o.frame >= $) {
                        $ = o.frame + (parseInt(M.autoSleep, 10) || 120);
                        for (i in Y) {
                            for (e = Y[i].tweens,
                                     t = e.length; --t > -1; )
                        ...
                        if (i = G._first,
                            (!i || i._paused) && M.autoSleep && !W._first && 1 === o._listeners.tick.length) {
                            for (; i && i._paused; )
                                i = i._next;
                            i || o.sleep()
                        }
            ...
            var H = function(t, e, i) {
                ...
                for (s = n.length; --s > -1; )
                    (o = n[s]) === e || o._gc || o._paused || (o._timeline !== e._timeline ? (h = h || J(e, 0, _),
                        0 === J(o, h, _) && (f[p++] = o)) : o._startTime <= u && o._startTime + o.totalDuration() / o._timeScale > u && ((_ || !o._initted) && u - o._startTime <= 2e-10 || (f[p++] = o)));
                for (s = p; --s > -1; )
                    if (o = f[s],
                ...
                return s /= n,
                    s > e ? s - e : i && s === e || !t._initted && s - e < 2 * c ? c : (s += t.totalDuration() / t._timeScale / n) > e + c ? 0 : s - e - c
            };
            a._init = function() {
                var t, e, i, r, n, s, a = this.vars, o = this._overwrittenProps, l = this._duration, h = !!a.immediateRender, u = a.ease;
                if (a.startAt) {
                ...
                if (this._ease = u = u ? u instanceof T ? u : "function" == typeof u ? new T(u,a.easeParams) : w[u] || M.defaultEase : M.defaultEase,
                ...
                a._initProps = function(e, i, r, n, s) {
                    ...
                    if (null == e)
                        return !1;
                    z[e._gsTweenID] && Z(),
                    this.vars.css || e.style && e !== t && e.nodeType && j.css && this.vars.autoCSS !== !1 && E(this.vars, e);
                    for (a in this.vars)
                        if (c = this.vars[a],
                                q[a])
                            c && (c instanceof Array || c.push && _(c)) && c.join("").indexOf("{self}") !== -1 && (this.vars[a] = c = this._swapSelfInParams(c, this));
                    ...
                    return n && this._kill(n, e) ? this._initProps(e, i, r, n, s) : this._overwrite > 1 && this._firstPT && r.length > 1 && K(e, this, i, this._overwrite, r) ? (this._kill(i, e),
                                this._initProps(e, i, r, n, s)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (z[e._gsTweenID] = !0),
                                l)
                }
                ,
                a.render = function(t, e, i) {
                    var r, n, s, a, o = this._time, l = this._duration, h = this._rawPrevTime;
                    if (t >= l - 1e-7)
                        ...
                        (h < 0 || t <= 0 && t >= -1e-7 || h === c && "isPause" !== this.data) && h !== t && (i = !0,
                        ...
                        3 === f && (u *= 2),
                            ...
                            1 === f ? this.ratio = 1 - u : 2 === f ? this.ratio = u : t / l < .5 ? this.ratio = u / 2 : this.ratio = 1 - u / 2
                    } else
    ...
    function(t, e) {
        ...
        var r = "animation.gsap"
            , n = window.console || {}
            , s = Function.prototype.bind.call(n.error || n.log || function() {}
            , n);
        t || s("(" + r + ") -> ERROR: The ScrollMagic main module could not be found. Please make sure it's loaded before this plugin or use an asynchronous loader like requirejs."),
        e || s("(" + r + ") -> ERROR: TweenLite or TweenMax could not be found. Please make sure GSAP is loaded before ScrollMagic or use an asynchronous loader like requirejs."),
            t.Scene.addOption("tweenChanges", !1, function(t) {
                return !!t
            }),
            t.Scene.extend(function() {
                var t, n = this, s = function() {
                    n._log && (Array.prototype.splice.call(arguments, 1, 0, "(" + r + ")", "->"),
                ...
                n.setTween = function(r, o, l) {
                    ...
                    if (t && n.removeTween(),
                            t = h,
                        r.repeat && r.repeat() === -1 && (t.repeat(-1),
                            t.yoyo(r.yoyo())),
                        n.tweenChanges() && !t.tweenTo && s(2, "WARNING: tweenChanges will only work if the TimelineMax object is available for ScrollMagic."),
                        ...
                        c.forEach(function(t, e) {
                            ...
                            if (r)
                                return s(2, "WARNING: Tweening the position of the trigger element affects the scene timing and should be avoided!"),
                                    !1
                        })
                    }
                    if (parseFloat(TweenLite.version) >= 1.14)
                        for (var p, _, d = t.getChildren ? t.getChildren(!0, !0, !1) : [t], m = function() {
